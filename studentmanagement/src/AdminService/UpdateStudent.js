...
{    
    ...
    return(
        <>
        <AdminDashboard/>
        <div className="UpdateStudent" style={divStyle}>
  <div class="col s12 m8 l4 offset-m2 offset-l4" style={{paddingTop:30,paddingRight:320,paddingLeft:280,paddingBottom:90}} >
    <div class="card" >
